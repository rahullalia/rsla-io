        ...
        <main className="min-h-screen bg-surface pt-32 pb-24 px-6 md:px-12">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="prose-container max-w-none font-mono text-sm md:text-base leading-relaxed text-textMuted">
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">1. Acceptance of Terms</h2>
                    <p className="mb-4">
                    ...
                    {/* ── 2. DEFINITIONS ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">2. Definitions</h2>
                    ...
                    {/* ── 3. SERVICES PROVIDED ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">3. Services Provided</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">4. Client Responsibilities</h2>
                    ...
                    {/* ── 5. PAYMENT TERMS ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">5. Payment Terms</h2>

                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">5.1 Fees and Billing</h3>
                    <ul className="list-disc pl-8 mb-8 space-y-3 marker:text-accent">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">5.2 Late Payments</h3>
                    <ul className="list-disc pl-8 mb-8 space-y-3 marker:text-accent">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">5.3 Taxes</h3>
                    <p className="mb-8">
                    ...
                    {/* ── 6. NO REFUND POLICY ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">6. No Refund Policy</h2>
                    ...
                    <ul className="list-disc pl-8 mb-4 space-y-3 marker:text-accent">
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">7. Cancellation and Termination</h2>

                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">7.1 Cancellation by Client</h3>
                    <ul className="list-disc pl-8 mb-8 space-y-3 marker:text-accent">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">7.2 Termination by RSL/A</h3>
                    <ul className="list-disc pl-8 mb-8 space-y-3 marker:text-accent">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">7.3 Effect of Termination</h3>
                    <p className="mb-8">
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">8. No Guarantees and Disclaimer of Warranties</h2>
                    <div className="mb-8 uppercase text-xs tracking-widest text-textMuted border-l-2 border-accent-border pl-4 py-4 space-y-4">
                        <p>
                    ...
                    {/* ── 9. USE OF AI TOOLS ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">9. Use of Artificial Intelligence</h2>
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">10. Intellectual Property</h2>

                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">10.1 Client Deliverables</h3>
                    <p className="mb-8">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">10.2 RSL/A Retained Rights</h3>
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">10.3 Portfolio and Case Study Rights</h3>
                    <p className="mb-8">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">10.4 Site Content</h3>
                    <p className="mb-8">
                    ...
                    {/* ── 11. CONFIDENTIALITY ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">11. Confidentiality</h2>
                    <p className="mb-4">
                    ...
                    {/* ── 12. INDEMNIFICATION ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">12. Indemnification</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">13. Limitation of Liability</h2>
                    <div className="mb-8 uppercase text-xs tracking-widest text-textMuted border-l-2 border-accent-border pl-4 py-4 space-y-4">
                        <p>
                    ...
                    {/* ── 14. FORCE MAJEURE ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">14. Force Majeure</h2>
                    <p className="mb-8">
                    ...
                    {/* ── 15. WEBSITE USE ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">15. Acceptable Use of the Site</h2>
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">16. Third-Party Platforms and Services</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">17. SMS and Text Messaging</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">18. Dispute Resolution</h2>

                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">18.1 Informal Resolution</h3>
                    <p className="mb-8">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">18.2 Binding Arbitration</h3>
                    <p className="mb-8">
                    ...
                    <h3 className="text-lg mt-8 mb-4 font-sans font-semibold text-text">18.3 Class Action Waiver</h3>
                    ...
                    {/* ── 19. GOVERNING LAW ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">19. Governing Law</h2>
                    <p className="mb-8">
                    ...
                    {/* ── 20. SEVERABILITY ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">20. Severability</h2>
                    <p className="mb-8">
                        If any provision of these Terms is found to be invalid, illegal, or unenforceable by a court of competent jurisdiction, that provision shall be modified to the minimum extent necessary to make it enforceable, or severed if modification is not possible, and the remaining provisions shall continue in full force and effect.
                    </p>

                    {/* ── 21. ENTIRE AGREEMENT ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">21. Entire Agreement</h2>
                    <p className="mb-8">
                    ...
                    {/* ── 22. AMENDMENTS ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">22. Amendments</h2>
                    <p className="mb-8">
                    ...
                    {/* ── 23. CONTACT ── */}
                    <h2 className="text-2xl mt-16 mb-6 font-sans font-bold text-text border-b border-accent-border pb-4">23. Contact Information</h2>
                    <p className="mb-4">
                    ...
                    <div className="mb-8 p-6 bg-surfaceAlt rounded-xl border border-accent-border">
                        ...
                        <span className="text-textLight text-xs uppercase tracking-widest mt-2 block">Legal Inquiries:</span>
