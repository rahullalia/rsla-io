...
export default function FounderSection() {
    ...
    return (
        <section ref={sectionRef} className="w-full bg-primary py-24 md:py-32">
            <div className="max-w-6xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-12 md:gap-16 items-start">
                ...
                <div className="flex-1">
                    <h2 className="founder-text font-sans font-bold text-3xl md:text-5xl text-dark tracking-tight mb-8">
                        Hi. I'm Rahul.
                    </h2>
                    <div className="space-y-6 font-body text-dark/70 text-base md:text-lg leading-relaxed">
                    ...
                    <div className="founder-text mt-10 border-t border-dark/10 pt-8">
                        <p className="font-drama italic font-normal text-xl text-dark mb-1">Rahul Lalia</p>
                        <p className="font-mono text-xs uppercase tracking-widest text-dark/40">Founder, RSL/A</p>
                    </div>

                    <Link to="/blog" className="founder-text link-underline inline-flex items-center gap-2 mt-8 font-sans font-bold text-accent hover:text-dark transition-colors group">
                        Learn AI with me
