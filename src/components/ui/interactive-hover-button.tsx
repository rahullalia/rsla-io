...
export function InteractiveHoverButton({
  ...
  return (
    <button
      className={cn(
        "group relative w-auto cursor-pointer overflow-hidden rounded-full border border-accent bg-accent text-white p-2 px-6 text-center font-semibold transition-colors",
        className
      )}
      {...props}
    >
